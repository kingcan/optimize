package com.sdmctech.connectTF.config

import java.util.Properties

import com.sdmctech.connectTF.multitenant.{MultiTenantDynamicProperties, TenantAdapter}
...
//(版本2)
	...
	val lrAssembleVector =Array( "userOneHotFeature","TAGS","CATEGORY","ACTOR","WRITER","DIRECTOR","itemOneHotFeature",
		"AGE","AGEREGISTERED","STAR","DURATION","EPISODE_TOTAL","HIT_COUNT")//22995+6
}
